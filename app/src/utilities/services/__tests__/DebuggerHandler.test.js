...
describe('DebuggerHandler.js tests', () => {
    ...
    it('resetDebuggerState() should reset the debugger state', () => {
        debuggerHandler.resetDebuggerState();
        expect(appInstance.setState).toHaveBeenCalledWith({ debugger: null });
    });

    it('setDebuggerState() should set the correct debugger state for missing fields', () => {
    ...
    it('setDebuggerState() should not set debugger state when all fields are selected', () => {
